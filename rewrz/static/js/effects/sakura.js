...
class SakuraEffect {
    constructor() {
        ...
        this.colors = [
            '#ffb3d9', '#ffc0cb', '#ffb6c1', '#ffd1dc',
            '#ffe4e1', '#fff0f5', '#f8f8ff', '#ffffff'
        ];
    }
    ...
    drawPetal(petal) {
        ...
        this.ctx.bezierCurveTo(-size * 0.5, -size * 0.3, -size, -size * 0.3, -size * 0.5, 0);
        this.ctx.bezierCurveTo(-size, size * 0.3, -size * 0.5, size * 0.6, 0, size);
        this.ctx.bezierCurveTo(size * 0.5, size * 0.6, size, size * 0.3, size * 0.5, 0);
        this.ctx.bezierCurveTo(size, -size * 0.3, size * 0.5, -size * 0.3, 0, size * 0.3);
        this.ctx.fill();
