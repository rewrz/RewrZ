...
async def media_library_page(request: Request, current_user: User = Depends(get_current_user)):
    """
    媒体库管理页面
    ...
    media_items = crud_media.get_all_media(db=request.state.db) # 从请求状态获取数据库会话
